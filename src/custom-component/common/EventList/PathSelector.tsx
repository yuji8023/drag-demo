...
// import { useSelected, useCurrentNode } from '@designable/react'
// import { TreeSelectProps, TreeSelect } from 'antd'
// import { treeToArr } from '../../../../service/utils'
...
//         : currentPath.join('.')
//       return buf.concat({
//         label: label ? label + `【${componentObj[node.props['x-component']] || ''}】` : label,
//         value,
//         node,
...
//   const newDataSource = treeToArr(dataSource).filter((item: any) => {
//     const propsName = item.node.props['x-component'];
//     return !!componentObj[propsName];
//   })
...
//       {...props}
//       onChange={(value) => {
//         props.onChange(value, findNode(newDataSource, value))
//       }}
