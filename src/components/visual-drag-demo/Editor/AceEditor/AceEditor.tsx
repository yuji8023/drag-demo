    ...
    return (
        <div className='ace'>
            <div className='btn-alignment'>
                <Button type='default' onClick={openSearchBox} className='btn'  icon='find' >查找</Button>
                <Button type='default' onClick={closeEditor} className='btn'  icon='close' >关闭</Button>
                <Button type='primary' className='btn' onClick={setCode}  icon='revert'>重置代码</Button>
                <Button type='primary' className='btn' onClick={getCode} icon="save">应用更改</Button>
            </div>
